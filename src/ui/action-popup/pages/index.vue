  ...
  <div class="min-h-[500px]">
    <div class="sparkles-container">
      <Sparkles
        ...
        :min-size="0.4"
        :max-size="1.4"
        :particle-density="300"
        class="size-full"
        :particle-color="particlesColor"
      />
    </div>
    <div class="relative max-w-6xl flex flex-col space-y-6 p-4">
      <h1 class="animate__animated animate__fadeInUp text-2xl font-semibold">
        {{ $t("home.sayHi") }} {{ authStore.user?.name }}
      </h1>
      ...
      >
        ...
        <div>
          <UButton
            ...
            :class="{
              'bg-orange-500/20 text-orange-500 hover:bg-orange-500 hover:text-white': authStore.planName !== 'Free',
            }"
          >
            {{ authStore.planName }}
          </UButton>
      ...
      <div class="flex flex-col gap-2">
        <UButton
          ...
          @click="openApp(app)"
          trailing-icon="i-ph-arrow-square-out-thin"
          :style="{
...
.sparkles-container::before {
  ...
  background: linear-gradient(
    180deg,
    rgba(252, 249, 250, 0) 0%,
    rgba(252, 249, 250, 1) 60%
  );
}
